...
async function convertBlob(blob, opts = {}) {
  ...
  // quality 1.0 is not "lossy at maximum": Chromium's encoder switches to
  // lossless WebP there. Verified by a canvas round-trip -- q=0.9 differed in
  // 194,633 subpixels of a noise image, q=1.0 in zero.
  ...
  return {
    ...
    lossless: info.lossy ? quality >= 1 : true,
  };
}
